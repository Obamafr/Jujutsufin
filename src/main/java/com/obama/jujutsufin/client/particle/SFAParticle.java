...
public class SFAParticle extends TextureSheetParticle {

    protected SFAParticle(ClientLevel clientLevel, double x, double y, double z, double dx, double dy, double dz, SpriteSet spriteSet) {
    ...
    public static SFAParticle.Provider provider(SpriteSet spriteSet) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType simpleParticleType, @NotNull ClientLevel clientLevel, double x, double y, double z, double dx, double dy, double dz) {
            return new SFAParticle(clientLevel, x, y, z, dx, dy, dz, this.spriteSet);
        }
    }
}
